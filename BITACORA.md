...
@@ -9,18 +9,399 @@ Registra aquí cada sesión de trabajo. Un commit por avance, con un mensaje cla
...
### [dd/mm/aaaa] — Fase 1: Planteamiento inicial
- Qué hice:
...
### [dd/mm/aaaa] — Fase 2: [nombre de la fase]
- Qué hice:
- Qué problema encontré:
- Cómo lo resolví:
- Próximo paso:
